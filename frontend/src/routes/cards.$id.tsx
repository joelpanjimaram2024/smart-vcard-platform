...
export const Route = createFileRoute("/cards/$id")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Save this contact, connect, and get in touch." },
    ],
  }),
  ...
  return (
    <div className="min-h-screen grid place-items-center px-6 bg-surface">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-slate-400">This card may have been removed.</p>
    ...
    <div className="min-h-screen bg-surface text-slate-200">
      <nav className="mx-auto max-w-4xl px-6 py-6 flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs font-mono uppercase tracking-widest text-slate-500 hover:text-brand"
        >
          Copy link
        </button>
      </nav>
        ...
        <div className="grid lg:grid-cols-[1fr_320px] gap-8">
          ...
          <div className="bg-card border border-white/5 rounded-3xl p-8 sm:p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              {card.bio && (
                <p className="mt-8 text-sm text-slate-400 leading-relaxed max-w-md">{card.bio}</p>
              )}
          ...
          <div className="bg-card border border-white/5 rounded-3xl p-6 sm:p-8 h-fit lg:sticky lg:top-8">
            ...
            <div className="bg-white rounded-2xl p-4 grid place-items-center">
              <QRCode value={url} size={240} dark="#0A0A0A" light="#FFFFFF" />
            </div>
...
function Detail({ label, value, href }: { label: string; value: string; href?: string }) {
  return (
    <div>
      ...
      <dd className="mt-1">
        {href ? (
          <a href={href} className="text-sm text-white hover:text-brand break-all transition">
            {value}
          </a>
        ) : (
